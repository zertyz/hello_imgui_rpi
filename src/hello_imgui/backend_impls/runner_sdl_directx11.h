...
{
    class RunnerSdlDirectX11 : public AbstractRunner
{
       public:
        RunnerSdlDirectX11(RunnerParams & runnerParams) : AbstractRunner(runnerParams) {}
        virtual ~RunnerSdlDirectX11() = default;
